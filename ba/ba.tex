...
Here I want to talk about how software is developed, give a brief history on how open-source developed over time and present different approaches of people working together on large problems. \cite{Chang2008}\\
...
Which ideals are fulfilled and which \cite{Chang2008} things are still in a messy state?\\
